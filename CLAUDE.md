...
## 📋 Версия 3.3.4 (2025-08-14) - Reserve Stock Integration & Production Hotfix

### 🆕 Новые возможности v3.3.4:
- **Интеграция резервных остатков** - полная поддержка резерва в производственном планировании
- **Критический production hotfix** - исправлена проблема с отсутствием товаров с резервом в списке производства
- **Улучшенная фильтрация API** - товары с резервом всегда включаются через Q(production_needed__gt=0) | Q(reserved_stock__gt=0)
- **Исправление JavaScript ошибок** - устранена runtime ошибка toFixed() в интерфейсе Точка
- **Колонки "Резерв"** - добавлены во все таблицы вкладки Точка (товары, производство, фильтрованное производство)
- **146+ товаров восстановлено** - все товары с резервом теперь видны в производственном планировании
- **Динамический расчет effective_stock** - учитывает резерв при параметре include_reserve
- **Бизнес-правило** - если товар имеет резерв, он всегда включается в список производства
