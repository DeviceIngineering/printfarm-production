"""
Base settings for PrintFarm production system.
"""
...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,kemomail3.keenetic.pro,*').split(',')
...
DATABASES = {
    'default': {
        ...
        'NAME': config('POSTGRES_DB', default='printfarm_db'),
        'USER': config('POSTGRES_USER', default='printfarm_user'),
