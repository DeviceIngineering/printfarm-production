...
export const PlanningPage: React.FC = () => {
  ...
  const mergedColumns = [
    ...
    },
    {
      ...
      render: (text: string, record: any) => (
        <div>
          <Tag color={record.is_in_planning ? 'blue' : 'orange'}>{text}</Tag>
          {record.has_duplicates && (
  ...
  return (
    <div style={{ padding: '0 24px' }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <Paragraph>
          Система планирования производства на основе данных аналитики
        </Paragraph>
      </div>
          ...
          <Card
            title={createCollapsibleTitle(
              ...
              <div>
                ...
                <Tag color="green">
                  {mergedData.filter((item: any) => item.is_in_planning).length} есть в Точке
                </Tag>
